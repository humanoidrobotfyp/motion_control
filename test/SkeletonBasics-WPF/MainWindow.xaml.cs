...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        int counter=3;
        string prevwalk = "1";
        Vector3D PRElbow, PRWrist;
        double PRPitch=0, PRRoll=0, PRE=0;
        AnglesCalculator ANGLES;
        WalkingControl WalkingSetting;
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            ANGLES = new AnglesCalculator();
            WalkingSetting = new WalkingControl();
            ...
            if (null != this.sensor)
            {
                ...
                interactionStream = new InteractionStream(this.sensor, new InteractionClient());
        ...
        private void WindowClosing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            myProcess.Close();
                ...
                System.IO.File.WriteAllText(@"D:\fyp\test\movement.txt", "exit");
